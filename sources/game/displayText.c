...
void dispWhatAPity(SDL_Renderer *renderer, const struct ComboTexture textToDisplay[], SDL_Rect *rect)
{
...
void dispWellDone(SDL_Renderer *renderer, const struct ComboTexture textTextures[], SDL_Rect *rect)
{
...
void dispGameFinished(SDL_Renderer *renderer, const struct ComboTexture textTextures[], SDL_Rect *rect)
{
...
void dispCardsDrawCount(SDL_Renderer *renderer, const struct ComboTexture *drawCountTextTexture, SDL_Rect *rect)
{
	rect->x = MARGIN;
...
void dispFinalDrawCount(SDL_Renderer *renderer, const struct ComboTexture *drawNumTextT)
{
